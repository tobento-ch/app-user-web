...
<html lang="<?= $view->esc($view->get('htmlLang', 'en')) ?>">
    ...
    <head>
        ...
        <meta name="description" content="<?= $view->etrans('Channel Verification') ?>">
    ...
    <body<?= $view->tagAttributes('body')->add('class', 'page')->render() ?>>
        ...
        <main class="page-main">
            ...
            <h1 class="title text-xl mb-m"><?= $view->etrans('Channel Verification') ?></h1>
            
            <?php $form = $view->form(); ?>
            <?= $form->form(['action' => $view->routeUrl('verification.verify', ['channel' => $channel])]) ?>
            ...
            <?php $form = $view->form(); ?>
            <?= $form->form(['action' => $view->routeUrl('verification.resend', ['channel' => $channel])]) ?>
