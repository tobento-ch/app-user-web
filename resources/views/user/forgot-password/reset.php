    ...
    <body<?= $view->tagAttributes('body')->add('class', 'page')->render() ?>>
        ...
        <main class="page-main">
            ...
            <div class="form-fields p-m mt-s">
                ...
                <?php $form = $view->form(); ?>
                <?= $form->form(['action' => $view->routeUrl('forgot-password.reset.verify')]) ?>
                <?= $form->input(name: 'token', type: 'hidden', value: $token->id()) ?>
                ...
                <div class="buttons spaced">
                    <?= $form->button(text: $view->trans('Reset password'), attributes: ['class' => 'button primary text-xs']) ?>
                </div>
